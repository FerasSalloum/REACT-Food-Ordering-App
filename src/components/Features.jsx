    ...
    <section className="max-padd-container  xl:py-28 py-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 gap-y-12">
        ...
        <div className="flexCenter flex-col gap-3 bg-deep p-4 py-8 rounded-xl">
          ...
          <p className="text-center">Savor freshly prepared, steaming hot meals delivered straigth to you</p>
        </div>
        <div className="flexCenter flex-col gap-3 bg-deep p-4 py-8 rounded-xl">
          <img src={fresh} alt="" height={44} width={44} />
          <div className="flexCenter flex-col">
            <h5 className="h5">Frech Foods</h5>
            <hr className="w-8 bg-secondary h-1 rounded-full border-none" />
          </div>
          <p className="text-center">We serve meals made fromthe freshest and finest ingredienta daily</p>
        </div>
        <div className="flexCenter flex-col gap-3 bg-deep p-4 py-8 rounded-xl">
